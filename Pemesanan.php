...
<body>
    <header class="header">
        ...
        <a href="#" class="logo"> <span>Secon </span>M </a>
    ...
    <section class="kendaraan" id="kendaraan">
        ...
        <form method="POST" action="Pesan.php">
            <div class="batasdaftarproduk">
                ...
                <br>
                <label for="get_alamat" class="heading4">Alamat : </label> <br> <input type="text" placeholder="Alamat" name = "Alamat" class="box" size = 100>
                <br>
